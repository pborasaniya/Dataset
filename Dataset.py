...
fileName = "parimal\Downloads\Project Report\project\project\Excel_data.xlsx"
...
plt.savefig(fileDir +'/parimal\Downloads\Project Report\project\project\Images\pari.png', dpi = 128)
plt.show()
